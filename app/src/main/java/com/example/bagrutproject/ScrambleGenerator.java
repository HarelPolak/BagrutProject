...
//    }
    ...
    public static String generateScramble2x2(){
        ...
        for(int i=0; i<scrambleLength; i++){
            ...
            if(i!=0){
                while((coulmn==prevCoulmn) || (coulmn==0 && prevCoulmn==1) || (coulmn==1 && prevCoulmn==0) || (coulmn==2 && prevCoulmn==3) || (coulmn==3 && prevCoulmn==2) || (coulmn==4 && prevCoulmn==5) || (coulmn==5 && prevCoulmn==4)){
                    coulmn = (int)(Math.random()*6);
                    randomMove = moves2x2[coulmn][(int)(Math.random()*3)];
                }
            }
